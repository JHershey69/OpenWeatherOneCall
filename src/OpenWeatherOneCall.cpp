/*
   ...
   Minutely, Hourly and alerts added - Jon Fuge
*/
...
int OpenWeatherOneCall::parseWeather(char* DKEY, char* GKEY, float SEEK_LATITUDE, float SEEK_LONGITUDE, bool SET_UNITS, int CITY_ID)
{
    ...
    current.dt = currently["dt"]; // 1586781931
	current.sunrise = currently["sunrise"]; // 1586773262
	current.sunset = currently["sunset"]; // 1586820773
	...
	current.sunriseTime = currently["sunrise"]; // 1586773262
	current.sunsetTime = currently["sunset"]; // 1586820773
...
//===================================
    ...
    {
        minutely[x].dt = everyminute[x]["dt"]; // 1586793600
...
//===================================
    ...
    {
        hourly[x].dt = everyhour[x]["dt"]; // 1586793600
...
//===================================
    ...
    {
        forecast[x].dt = daily[x]["dt"]; // 1586793600
        forecast[x].sunrise = daily[x]["sunrise"]; // 1586773262
        forecast[x].sunset = daily[x]["sunset"]; // 1586820773
...
//****************************************
    ...
    alerts.start = alert["start"]; // 1586781931
    alerts.end = alert["end"]; // 1586781931
